	...
	const renderHeader = () => (
		<View style={styles.headerContent}>
			...
			<Text style={styles.description}>
				Get ready to move! These whole body warm-up exercises are
				designed to activate your muscles, loosen your joints, and
				prepare you for peak basketball performance. Start strong, stay
				flexible, and reduce your risk of injury—let’s get you
				game-ready!
			</Text>
