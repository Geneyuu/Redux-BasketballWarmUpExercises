...
const LowerBodyIndex = () => {
	...
	const handleStartPress = () => {
		...
		router.push("/home/LowerBody/StartWarmUps");
	...
	const renderHeader = () => (
		<View style={styles.headerContent}>
			<Image
				source={require("../../../../assets/images/inplacepreview.png")}
				style={styles.mainImage}
			/>
			<Text style={styles.description}>
				Get ready to boost your basketball performance with dynamic
				lower body warm-up exercises. These movements help improve
				mobility, strength, and injury prevention before you hit the
				court.
			</Text>
