...
const TabIcon = ({ icon, focused, color }) => (
     <View style={styles.iconWrapper}>
          ...
          <Ionicons name={icon} size={hp(3)} color={focused ? '#161616' : color} />
     </View>
);

const TabButton = ({ onPress, children, style }) => (
     <TouchableOpacity onPress={onPress} style={({ pressed }) => [{ opacity: pressed ? 0.5 : 1 }, style]}>
          <View
               style={{
               ...
               <Tabs.Screen
                    ...
                    options={{
                         ...
                         tabBarIcon: ({ color, focused }) => (
                              <TabIcon
                                   icon={focused ? 'basketball-sharp' : 'basketball-outline'}
                                   color={color}
                                   focused={focused}
                              />
                         ),
