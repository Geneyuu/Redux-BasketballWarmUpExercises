...
export default function Index() {
     ...
     //here para mafetch yung latest data na nabago ng user sa settings, so everytime na irerestart yung app mafetch yung latest datas. like duration, restDuration, restTimer.
     useEffect(() => {
